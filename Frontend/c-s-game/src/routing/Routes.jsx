...
const AppRoutes = () => {
  ...
  return (
    <Routes location={location}>
      ...
      <Route path={MATERIALS_ROUTE} element={
        <ProtectedRoute>
          <Materials />
        </ProtectedRoute>
      } />
      <Route path={TESTS_ROUTE} element={
        <ProtectedRoute>
          <Tests />
        </ProtectedRoute>
      } />
      <Route path={PERSONAL_ACCOUNT_ROUTE} element={
        <ProtectedRoute>
          <PersonalAccount />
        </ProtectedRoute>
      } />
      <Route path={ANALYTICS_ROUTE} element={
        <ProtectedRoute>
          <Analytics />
        </ProtectedRoute>
      } />
      <Route path={TEST_DETAILS_ROUTE} element={
        <ProtectedRoute>
          <TestDetails />
        </ProtectedRoute>
      } />
      <Route path={MATERIAL_DETAILS_ROUTE} element={
        <ProtectedRoute>
          <MaterialDetails />
        </ProtectedRoute>
      } />
