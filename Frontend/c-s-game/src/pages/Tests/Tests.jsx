  ...
  const [tests] = useState([
    {
      ...
      questions: [
        { id: 1, text: "Что такое JSX?", options: ["JavaScript XML", "Java Syntax Extension", "JavaScript Extension"], correctAnswer: 0, points: 10, materials: null },
        { id: 2, text: "Какой метод жизненного цикла вызывается после рендеринга компонента?", options: ["componentDidMount", "componentWillMount", "shouldComponentUpdate"], correctAnswer: 0, points: 15, materials: null },
        { id: 3, text: "Что возвращает метод render()?", options: ["HTML", "React элементы", "Строку"], correctAnswer: 1, points: 10, materials: null }
      ],
      openQuestions: [
        { id: 1, text: "Опишите разницу между функциональными и классовыми компонентами", points: 25, materials: null, userAnswer: "" }
      ],
    ...
    },
    {
      ...
      questions: [
        { id: 4, text: "Что такое деструктуризация?", options: ["Разрушение объекта", "Извлечение значений из объектов/массивов", "Удаление свойств объекта"], correctAnswer: 1, points: 10, materials: null },
        { id: 5, text: "Что делает оператор spread?", options: ["Копирует объект", "Распространяет значения", "Объединяет массивы"], correctAnswer: 1, points: 10, materials: null }
      ],
      openQuestions: [
        { id: 2, text: "Объясните разницу между let, const и var", points: 20, materials: null, userAnswer: "" },
        { id: 3, text: "Напишите пример использования Promise.all()", points: 25, materials: null, userAnswer: "" }
      ],
    ...
    },
    {
      ...
      questions: [
        { id: 6, text: "Для чего используется flexbox?", options: ["Для одномерных макетов", "Для двумерных макетов", "Для анимаций"], correctAnswer: 0, points: 10, materials: null },
        { id: 7, text: "Какое свойство CSS Grid определяет колонки?", options: ["grid-template-columns", "grid-columns", "grid-col"], correctAnswer: 0, points: 10, materials: null }
      ],
      openQuestions: [
        { id: 4, text: "Создайте сетку из 3 колонок с равной шириной и промежутком 20px", points: 30, materials: "Пример кода grid", userAnswer: "" }
      ],
      deadline: "2024-03-10T23:59:59",
      publicationDate: "2024-02-01",
      relatedMaterials: [
        { id: 4, title: "Основы CSS Grid и Flexbox", link: "/materials/3" }
      ],
      userScore: 0,
      maxScore: 50,
    ...
    },
    {
      ...
      questions: [
        { id: 8, text: "Что такое Node.js?", options: ["Среда выполнения JavaScript", "Фреймворк", "Библиотека"], correctAnswer: 0, points: 10, materials: null },
        { id: 9, text: "Какой модуль используется для создания HTTP сервера?", options: ["http", "https", "server"], correctAnswer: 0, points: 10, materials: null }
      ],
      openQuestions: [
        { id: 5, text: "Опишите архитектуру Event Loop в Node.js", points: 30, materials: null, userAnswer: "" },
        { id: 6, text: "Напишите простой HTTP сервер на Express", points: 25, materials: "Пример кода Express", userAnswer: "" }
      ],
      deadline: "2024-03-25T23:59:59",
      publicationDate: "2024-02-10",
      relatedMaterials: [
        { id: 5, title: "Основы Node.js и Express", link: "/materials/4" }
      ],
      userScore: 65,
      maxScore: 85,
      timeLimit: 90,
  ...
  return (
    <div className="tests-page">
      ...
      <div className="tests-stats">
        ...
        <div className="test-stat-card">
          <div className="test-stat-info">
            <div className="test-stat-value">{tests.filter(t => t.status === 'completed').length}</div>
        ...
        <div className="test-stat-card">
          <div className="test-stat-info">
            <div className="test-stat-value">{tests.reduce((acc, test) => acc + test.passedBy, 0)}</div>
            <div className="test-stat-label">Учеников прошли</div>
          </div>
        </div>
      </div>
            ...
            <div key={test.id} className="test-card">
              ...
              <div className="test-content">
                <div className="test-stats-details">
                  ...
                  <div className="stat-detail">
                    <span className="stat-label">Прошли:</span>
                    <span className="stat-value">{test.passedBy}</span>
                  </div>
                </div>
                ...
                <div className="questions-summary">
                  ...
                  <div className="question-types">
                    <span className="question-type">
                      С выбором: <strong>{test.questions.length}</strong>
                    </span>
                    <span className="question-type">
                      Открытые: <strong>{test.openQuestions.length}</strong>
                    </span>
                  </div>
                </div>
              ...
              <div className="test-footer">
                <div className="test-actions">
                  {test.status === 'completed' ? (
                    <>
                      <button className="action-btn view-results-btn">
